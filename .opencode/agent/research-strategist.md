...
Read `docs/principles/research_strategy.md` for the strategic framework.
...
**Use webfetch** to check recent conference programs, trending papers, and industry announcements for evidence.
...
- Current pace of publication in the area (use `webfetch` for recent preprints)
...
- **Use evidence.** Back up claims about field dynamics, competition, and timing with specific papers, groups, or trends you found via webfetch.
