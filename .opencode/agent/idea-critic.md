...
Read `docs/principles/research_strategy.md` (in the project repo) for the evaluative framework you should apply.
...
- Search for existing work in this direction. Use `webfetch` to check recent papers, preprints, and blog posts (Semantic Scholar API, arXiv, Google Scholar).
...
- Use `webfetch` to gauge current activity level and community interest.
