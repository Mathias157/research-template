...
The documentation is built with [Sphinx](https://www.sphinx-doc.org/) and hosted on GitHub Pages. The default environment (`pixi shell`) includes all necessary tools so no extra installation is needed.
